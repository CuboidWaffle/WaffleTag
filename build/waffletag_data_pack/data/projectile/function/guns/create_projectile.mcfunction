...
execute as @s at @s anchored eyes positioned ^ ^ ^0.5 run summon minecraft:trident ~ ~-0.125 ~ {item: {id: "trident", count: 1b}, Silent: 1b, OnGround: 0b, Invulnerable: 1b, PierceLevel: -1b, pickup: 0b, Tags: ["projectile", "new_projectile"], HasBeenShot: 0b, Passengers: [{id: "minecraft:item_display", item: {id: "minecraft:redstone_block", count: 1b, components: {custom_model_data: {strings: ["projectile"]}}}, transformation: {translation: [0.0d, -0.375d, 0.0d], scale: [0.25d, 0.25d, 0.25d], left_rotation: [0.0d, 0.0d, 0.0d, 1.0d], right_rotation: [0.0d, 0.0d, 0.0d, 1.0d]}, Tags: ["projectile_display"]}]}
tag @s add player
